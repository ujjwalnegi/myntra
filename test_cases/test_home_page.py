...
class Test01_Myntra_Home_Page:
    ...
    def test_hover_women_link(self,setup):
        driver = setup
        driver.get(self.myntra_home_page_url) #we are using self here because myntra_home_page_url is a class-level variable, and we're accessing it inside a method of the same class.
